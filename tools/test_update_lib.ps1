...
Assert-Equal -1 (Compare-Versions '2026.7.1-beta.9' '2026.7.1') 'cmp-named-prerelease-before-base'
Assert-Equal -1 (Compare-Versions '2026.7.1' '2026.7.1-1') 'cmp-base-before-stable-correction'
Assert-Equal -1 (Compare-Versions '2026.7.1-1' '2026.7.1-2') 'cmp-stable-correction-order'
Assert-Equal 1 (Compare-Versions '2026.7.1-2' '2026.7.1') 'cmp-stable-correction-after-base'
Assert-Equal -1 (Compare-Versions '2026.7.1-beta.9' '2026.7.1-2') 'cmp-named-prerelease-before-stable-correction'
