...
.EXAMPLE   .\restore-config.ps1 -From "E:\OpenClawGateway\secrets-backup\full-20260619-220000"
...
if ($Latest -or -not $From) {
    $From = (Get-ChildItem 'E:\OpenClawGateway\secrets-backup' -Directory -Filter 'full-*' -ErrorAction SilentlyContinue |
