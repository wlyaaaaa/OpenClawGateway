...
静默开机自启 · 心跳自愈 · 周期自动更新 · 成本安全模式 · 模型/提供方一键切换
...
- **周期自动更新**：每周 stable 通道 `npm` 更新，与开机解耦（永不因 registry 超时崩溃）。
...
---
基于 [OpenClaw](https://docs.openclaw.ai) v2026.6.8 原生 `daemon` / `update` 机制构建。
